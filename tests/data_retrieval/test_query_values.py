...
from tradesman.data_retrieval.osm_tags.query_writer import (
    amenity_count_query,
    building_area_query,
...
class TestOsmTagVAlues(unittest.TestCase):
    ...
    def test_building_area_query_no_kwargs(self):
        self.assertEqual(
            building_area_query(self.df, func="set_zero"),
